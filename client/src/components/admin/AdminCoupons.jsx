...
const AdminCoupons = ({ coupons, setIsCouponModalOpen, handleToggleCoupon, setCouponToDelete }) => {
  return (
    <div>
      ...
      <div style={{ backgroundColor: 'var(--surface-color)', padding: '20px', borderRadius: '12px' }}>
        <div className="mobile-table-header" style={{ gridTemplateColumns: '1.5fr 1fr 1fr 1fr 0.5fr', fontWeight: 'bold', paddingBottom: '15px', borderBottom: '1px solid var(--border-color)', marginBottom: '15px' }}>
          <div>Coupon Code</div>
          <div>Discount</div>
          <div>Usage</div>
          <div>Status</div>
        ...
        {coupons.length === 0 ? (
          ...
          coupons.map(coupon => (
            <div key={coupon._id} className="mobile-table-row" style={{ gridTemplateColumns: '1.5fr 1fr 1fr 1fr 0.5fr', alignItems: 'center', padding: '15px 0', borderBottom: '1px solid var(--border-color)' }}>
              <div>
